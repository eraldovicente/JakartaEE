...
//        env.put("jboss.naming.client.ejb.context", true);
        try {
            ...
            service = (ServiceEjbRemota) ctx.lookup("ejb:/appejb-remote/ServiceEjb!org.aguzman.webapp.ejb.service.ServiceEjbRemota?stateful");
            service2 = (ServiceEjbRemota) ctx.lookup("ejb:/appejb-remote/ServiceEjb!org.aguzman.webapp.ejb.service.ServiceEjbRemota?stateful");
