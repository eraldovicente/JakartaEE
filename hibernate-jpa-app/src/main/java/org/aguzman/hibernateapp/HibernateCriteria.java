...
public class HibernateCriteria {
    public static void main(String[] args) {
        ...
        clientes = em.createQuery(query).setParameter("nombre", "Eraldo").getResultList();
        clientes.forEach(System.out::println);
        ...
        clientes = em.createQuery(query).setParameter("nombreParam", "%ral%").getResultList();
        clientes.forEach(System.out::println);
        ...
        clientes = em.createQuery(query).setParameter("nombres", Arrays.asList("Andres", "John", "Era")).getResultList();
        clientes.forEach(System.out::println);
        ...
        System.out.println("================ consulta con los predicados conjuncion and y disyunción ================");

        query = criteria.createQuery(Cliente.class);
        from = query.from(Cliente.class);
        Predicate porNombre = criteria.equal(from.get("nombre"), "Eraldo");
        ...
        CriteriaQuery<String> queryStrig = criteria.createQuery(String.class);
        from = queryStrig.from(Cliente.class);
        queryStrig.select(from.get("nombre"));
        List<String> nombres = em.createQuery(queryStrig).getResultList();
        nombres.forEach(System.out::println);

        System.out.println("============== consulta solo el nombre de los clientes unicos con distinct =================");
        queryStrig = criteria.createQuery(String.class);
        from = queryStrig.from(Cliente.class);
        queryStrig.select(criteria.upper(from.get("nombre"))).distinct(true);
        nombres = em.createQuery(queryStrig).getResultList();
        nombres.forEach(System.out::println);

        System.out.println("============== consulta por nombres y apellidos concatenados upper o lower =================");
        queryStrig = criteria.createQuery(String.class);
        from = queryStrig.from(Cliente.class);
        queryStrig.select(criteria.upper(criteria.concat(criteria.concat(from.get("nombre"), " "), from.get("apellido"))));
        nombres = em.createQuery(queryStrig).getResultList();
        nombres.forEach(System.out::println);
        ...
        from = queryObject.from(Cliente.class);
        queryObject.multiselect(from.get("id"), from.get("nombre"), from.get("apellido")).where(criteria.like(from.get("nombre"), "%jo%"));
