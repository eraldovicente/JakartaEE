...
<body>
    ...
    <form action="/webapp-form/form" method="post">
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input id="username" type="text" name="username" class="form-control" value="${param.username}">
            </div>
            <%
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input id="password" type="text" name="password" class="form-control" value="${param.password}">
            </div>
            <%
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input id="email" type="text" name="email" class="form-control" value="${param.email}">
            </div>
            <%
        ...
        <div class="row mb-3">
            ...
            <div class="form-check col-sm-2">
                ...
                ${paramValues.roles.stream().anyMatch(v->v.equals("ROLE_ADMIN").get()?"selected":"")}>
        ...
        <div class="row mb-3">
            ...
            <div class="form-check">
                <input type="checkbox" name="habilitar" id="habilitar" checked="form-check-input">
            </div>
        </div>
        <div class="row mb-3">
            <div>
